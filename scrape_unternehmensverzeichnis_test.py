...
async def main():
    ...
    # Test-Parameter
    test_cases = [
        {"city": "Stuttgart", "industry": "IT-Service", "max_pages": 2},
        {"city": "München", "industry": "Softwareentwicklung", "max_pages": 2},
        {"city": "Villingen-Schwenningen", "industry": "Bürotechnik", "max_pages": 1},
    ]
    ...
    logger.info(
        f"Mit Beschreibung: {with_description} ({with_description/len(all_results)*100:.1f}%)"
    )
