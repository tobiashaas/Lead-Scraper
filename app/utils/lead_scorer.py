...
class LeadScorer:
    ...
    HIGH_VALUE_INDUSTRIES = {
        "software", "it", "tech", "saas", "cloud", "ai", "ml",
        "consulting", "beratung", "engineering", "automation",
        "fintech", "medtech", "healthtech", "e-commerce",
    }
    
    # Technologien die auf moderne Firmen hindeuten
    MODERN_TECHNOLOGIES = {
        "react", "vue", "angular", "node", "python", "aws", "azure",
        "kubernetes", "docker", "microservices", "api", "rest",
        "graphql", "mongodb", "postgresql", "redis", "kafka",
    }
    ...
    def score_lead(self, company_data: dict[str, Any]) -> dict[str, Any]:
        ...
        logger.info(f"Lead scored: {company_data.get('name', 'Unknown')} - Score: {score} ({quality})")
