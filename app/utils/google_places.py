...
class GooglePlacesClient:
    ...
    def search_company(
        ...
        try:
            # Text-Suche
            places_result = self.client.places(query=query, region=region, language="de")
...
async def enrich_with_google_places(
    ...
    for result in results:
        ...
        try:
            ...
            gmb_data = client.search_company(company_name=result.company_name, city=result.city)
