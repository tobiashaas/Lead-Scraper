...
class TestScrapingEndpoints:
    ...
    def test_create_scraping_job(self, create_test_source, sample_scraping_job_data, db_session, client, auth_headers):
        ...
        response = client.post("/api/v1/scraping/jobs", json=sample_scraping_job_data, headers=auth_headers)
    ...
    def test_create_scraping_job_invalid_source(self, sample_scraping_job_data, client, auth_headers):
    ...
    def test_get_scraping_job_by_id(self, create_test_source, sample_scraping_job_data, client, auth_headers):
        """Test: Get scraping job by ID"""
        # Create a job first
        create_response = client.post("/api/v1/scraping/jobs", json=sample_scraping_job_data, headers=auth_headers)
    ...
    def test_cancel_scraping_job(self, create_test_source, sample_scraping_job_data, client, auth_headers):
    ...
    def test_scraping_job_response_schema(self, create_test_source, sample_scraping_job_data, client, auth_headers):
    ...
    def test_scraping_job_config(self, create_test_source, sample_scraping_job_data, client, auth_headers):
