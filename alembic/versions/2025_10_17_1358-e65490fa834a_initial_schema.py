...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "lead_status",
            sa.Enum("NEW", "QUALIFIED", "CONTACTED", "CONVERTED", "REJECTED", name="leadstatus"),
            nullable=True,
        ),
        sa.Column(
            "lead_quality",
            sa.Enum("A", "B", "C", "D", "UNKNOWN", name="leadquality"),
            nullable=True,
        ),
    ...
    op.create_index(
        op.f("ix_companies_google_place_id"), "companies", ["google_place_id"], unique=True
    )
    ...
    op.create_index(
        op.f("ix_companies_register_number"), "companies", ["register_number"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_company_notes_company_id"), "company_notes", ["company_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_duplicate_candidates_id"), "duplicate_candidates", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_duplicate_candidates_overall_similarity"),
        "duplicate_candidates",
        ["overall_similarity"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_scraping_jobs_created_at"), "scraping_jobs", ["created_at"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_duplicate_candidates_overall_similarity"), table_name="duplicate_candidates"
    )
